        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">k2nguyenngocthanh@gmail.com</span>

              <a
                href="mailto:k2nguyenngocthanh@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+84 947 966 788 </span>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">huythanh2910</span>

              <a
                href="https://www.facebook.com/huythanh2910/"
                className="contact__button"
              >
                Call me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
